...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'movie_ott_film_group') # Support Chat Link Without https:// or @
...
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 'https://tinyurl.com/2se2fuzc')
